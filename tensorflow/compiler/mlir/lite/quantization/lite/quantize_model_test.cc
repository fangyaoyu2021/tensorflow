...
TEST_P(QuantizeConvModelTest, QuantizationSucceeds) {
  EXPECT_TRUE(QuantizeModelAllOperators(&model_, tensor_type_, tensor_type_,
...
TEST_P(QuantizeConvModelTest, SkipUnspecifiedLayer) {
  EXPECT_TRUE(QuantizeModel(&model_, TensorType_FLOAT32, TensorType_FLOAT32,
...
TEST_F(QuantizeSplitModelTest, QuantizeSplit) {
  EXPECT_TRUE(QuantizeModelAllOperators(&model_, TensorType_INT8,
                                        TensorType_INT8, /*allow_float=*/false,
...
TEST_P(QuantizeConvModel2Test, VerifyConvQuantization) {
  ASSERT_TRUE(QuantizeModelAllOperators(&model_, tensor_type_, tensor_type_,
                                        /*allow_float=*/false, tensor_type_,
                                        output_buffer_)
                  .ok());
...
TEST_F(QuantizeSoftmaxTest, VerifySoftmaxQuantization) {
  ASSERT_TRUE(QuantizeModelAllOperators(&model_, TensorType_INT8,
                                        TensorType_INT8, /*allow_float=*/false,
                                        TensorType_INT8, output_buffer_)
                  .ok());
...
TEST_F(QuantizeLSTMTest, VerifyLSTM) {
  ASSERT_TRUE(QuantizeModelAllOperators(
...
TEST_P(QuantizeCustomOpTest, VerifyMixedQuantization) {
  ASSERT_TRUE(QuantizeModelAllOperators(&model_, GetParam(), GetParam(),
...
TEST_F(QuantizePackTest, VerifyPack) {
  ASSERT_TRUE(QuantizeModel(&model_, output_buffer_).ok());
